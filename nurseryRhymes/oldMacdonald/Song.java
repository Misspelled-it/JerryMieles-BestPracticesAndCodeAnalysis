...
public class Song {
	...
	public static final void songIntro () {
		//output the beginning of the song which is static and prompt user for an animal
	...
	private static void pause() {
		//made this method to clean up all the try/catch blocks from songIntro and printSong
		try {
			Thread.sleep(1500);
	...
	public Song (String animal) {
		//check if the animal input is chicken and make chicken noises otherwise that animal isn't on the farm
	...
	void printSong (String animal, String animalSound) {
		//output the song with the appended animal sounds
	...
	private static void intro() {
		//removed this from the Song method because it causes an infinite loop
		do{
			try {
				Thread.sleep(3000);
			} catch (InterruptedException e) {
